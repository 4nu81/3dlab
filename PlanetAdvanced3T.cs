...
namespace GL3DLab
{
    ...
    {
      List<o2Object> MyList;
      Thread runThat;
      PlanetAdvanced3T Sim;

      public bool isRunning() 
      {
        return runThat.IsAlive;
      }

      public MyThread(List<o2Object> List, PlanetAdvanced3T p)
      {
        MyList = List;
        Sim = p;
        runThat = new Thread(new ThreadStart(StartThread));
      }
      ...
      public void StartThread()
      {
        ...
        {
          #region Bewegung
          foreach (o2Object o in MyList)
          {
            o.MoveObject(Sim.Objects);
            if (Sim.showTrace)
            {
              o.Trace();
            }
    ...
    /// </summary>
    public class PlanetAdvanced3T : BaseFigure, IMouseControlled
    {
        /// <summary>
        ...
        /// </summary>
        public List<o2Object> Objects = new List<o2Object>();
        private List<o2Object> Objects0 = new List<o2Object>();
        private List<o2Object> Objects1 = new List<o2Object>();
        private List<o2Object> Objects2 = new List<o2Object>();      
        private List<o2Object> Objects3 = new List<o2Object>();

        private int listIndex = 0;
        private List<o2Object> getList()
        {
          listIndex += 1;
        ...
        public void ConvertPlanet2Sun(o2Object Planet2Convert)
        {
            if (
            ...
            {                
                ...
                Objects0.Remove(Planet2Convert);
                Objects1.Remove(Planet2Convert);
                Objects2.Remove(Planet2Convert);
                Objects3.Remove(Planet2Convert);
            }            
        }
      ...
      /// <summary>
        ...
        {
            t1 = new MyThread(Objects0, this);
            t2 = new MyThread(Objects1, this);
            t3 = new MyThread(Objects2, this);
            t4 = new MyThread(Objects3, this);
            ...
            Cam.Y = 0;
            Cam.Z = 250000;            
            DefaultLight = LightSource.bluelight;
        }
